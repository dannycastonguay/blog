...
That is what made Khan Academy powerful: you could press pause on a good teacher and take your time. Grant Sanderson's channel 3Blue1Brown goes further, building visualizations that let a hard idea, a [Riemann zeta function](https://www.3blue1brown.com/lessons/zeta/) or how a [neural network works](https://www.3blue1brown.com/lessons/neural-networks/), actually sink in while you pause and rewatch. Go slow, but keep challenging. If you stop challenging yourself, you stop building the muscle.
...
First, [Art of Problem Solving](https://artofproblemsolving.com/), an American math curriculum. It is not expensive and we simply follow the textbooks: thirty minutes, an hour, sometimes two, seven days a week. I am sure China, Russia, and others have excellent programs too. This is the one I know.

Second, [Code Submission Evaluation System](https://cses.fi), a sequence of programming problems. These are more abstract and harder than the pure-math ones. A tough Art of Problem Solving question might take thirty minutes. A hard CSES problem can take six or seven hours, sometimes spread across days. The description might be forty words. The solution requires discovering a great deal.
