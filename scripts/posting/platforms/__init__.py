...
class SocialMediaPlatform(ABC):
    ...
    @abstractmethod
    def post_content(
        self, content: str, page_name: str, platform_folder: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def create_success_result(
        self, page_name: str, content: str, post_id: str, url: str
    ) -> Dict[str, Any]:
        """
    ...
    def create_error_result(
        self, page_name: str, content: str, error: str
    ) -> Dict[str, Any]:
        """
